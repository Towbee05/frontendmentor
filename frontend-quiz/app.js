...
<article class="space-y-3 tablet:space-y-6 laptop:space-y-6">
    <button data-course="HTML" class="bg-white p-3 rounded-xl flex w-full items-center gap-4 course-btn" >
    ...
    <button data-course="CSS" class="bg-white p-3 rounded-xl flex w-full items-center gap-4 course-btn" >
    ...
    <button data-course="JavaScript" class="bg-white p-3 rounded-xl flex w-full items-center gap-4 course-btn" >
    ...
    <button data-course="Accessibility" class="bg-white p-3 rounded-xl flex w-full items-center gap-4 course-btn" >
