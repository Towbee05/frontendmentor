    ...
    carddetails.innerHTML = `
        <div class="relative tablet:grid tablet:grid-cols-custom-column laptop:grid laptop:grid-cols-custom-column2">
            <div class="relative laptop:pb-16">
                <button class='absolute uppercase mobile:top-4 left-4 tablet:bottom-4 laptop:bottom-20 bg-black flex text-white gap-3 items-center px-4 py-[14px] group hover:bg-white hover:text-black ' id='view-btn'>
